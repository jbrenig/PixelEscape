 ...
 */
public class CustomGameScreen extends PixelScreen {
	...
	public CustomGameScreen(final PixelEscape game) {
		super(game);
		//Setting up stage
		...
		//Back Button
		{
			...
			btnBack.addListener(new ClickListener() {
				...
				public void clicked(InputEvent event, float x, float y) {
					CustomGameScreen.this.game.setScreen(new SettingsScreen(CustomGameScreen.this.game));
				}
			});
